...
kubectl logs -n ntnx-system csi-provisioner-ntnx-plugin-0 -c csi-snapshotter > csi-snapshotter.log
kubectl logs -n ntnx-system csi-provisioner-ntnx-plugin-0 -c csi-external-health-monitor-controller > csi-external-health-monitor-controller.log
